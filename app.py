...
def generate_music(start_note, sequence_type, tempo_type, harmony, harmony_type, ottave, bass_clef, bpm=100,
    ...
    if sequence_type == "Binary":
        s = genera_binary(start_note, interval, leap, ottave, bass_clef)
    elif sequence_type == "Quaternary":
        s = genera_quaternary(start_note, interval1, leap1, interval2, leap2, ottave, bass_clef)
    elif sequence_type == "Free":
        s = genera_free(start_note, sequence, ottave, bass_clef)
    else:
